...
namespace Cult.Toolkit
{
    internal static class FuzzyMatcher
    {
        ...
        internal static bool FuzzyMatch(string stringToSearch, string pattern)
        {
            var patternIdx = 0;
            var strIdx = 0;
        ...
        /// <returns>true if each character in pattern is found sequentially within stringToSearch; otherwise, false.</returns>
        internal static bool FuzzyMatch(string stringToSearch, string pattern, out int outScore)
        {
            // Score consts
